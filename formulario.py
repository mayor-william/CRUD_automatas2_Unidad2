...
class FormularioArticulos:
    ...
    def carga_articulos(self):
        ...
        self.cuaderno1.add(self.pagina1, text="alta de articulos")
    ...
    def consulta_por_codigo(self):
        ...
        self.cuaderno1.add(self.pagina2, text="Buscar")
        self.labelframe1=ttk.LabelFrame(self.pagina2, text="Artículo")
        self.labelframe1.grid(column=0, row=0, padx=5, pady=10)
        self.label1=ttk.Label(self.labelframe1, text="Articulo buscado:")
        self.label1.grid(column=0, row=0, padx=4, pady=4)
    ...
    def listado_completo(self):
        ...
        '''   
        self.boton2 = ttk.Button(self.labelframe1, text="hacer PDF", command=crear_pdf.generarReporte())
        self.boton2.grid(column=0, row=1, padx=4, pady=4)
        self.scrolledtext2 = st.ScrolledText(self.labelframe1, width=30, height=10)
    ...
    def listar(self):
        ...
        for fila in respuesta:
             self.scrolledtext1.insert(tk.END, "descripción:"+fila[0]+
                                                "\nprecio:"+str(fila[1])+"\n\n")
    ...
    def borrado(self):
        ...
        self.labelframe1.grid(column=0, row=0, padx=5, pady=10)
        self.label1=ttk.Label(self.labelframe1, text="Articulo a borrar:")
        self.label1.grid(column=0, row=0, padx=4, pady=4)
    ...
    def modificar(self):
        ...
        self.labelframe1.grid(column=0, row=0, padx=5, pady=10)
        self.label1=ttk.Label(self.labelframe1, text="articulo a modificar:")
        self.label1.grid(column=0, row=0, padx=4, pady=4)
